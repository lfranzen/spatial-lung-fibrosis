...
if (SPECIES == "human") {
  ...
  # cols_donor <- setNames(c(RColorBrewer::brewer.pal(5, "Blues")[2:5], RColorBrewer::brewer.pal(5, "Oranges")[2:5]), 
  ...
  # cols_group <- RColorBrewer::brewer.pal(8, "Set2")
  
  cols_group <- setNames(RColorBrewer::brewer.pal(4, "Spectral")[c(1,4, 2,3)], 
                         nm = c("d21_BLM", "d21_CTRL","d7_BLM", "d7_CTRL"))
  
  # cols_cond <- setNames(cols_group[1:2], nm = c("bleomycin", "control"))
  # cols_cond <- setNames(c("#D59800", "#5DA6C6"), nm = c("bleomycin", "control"))
